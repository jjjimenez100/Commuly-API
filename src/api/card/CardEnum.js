...
const CONTENT_CARD_TYPES_WITH_CLOUD_FILES = [
  SCHEDULED_CONTENT,
  IMAGE_CONTENT,
  VIDEO_CONTENT,
];
...
module.exports = {
  ...
  QUESTION_CARD_TYPES,
  MULTIPLE_CHOICE_QUESTION,
  MULTIPLE_RESPONSE_CONTENT,
  LIKERT_QUESTION,
  LIKERT_RESPONSE_CONTENT,
  COLUMN_ORDERING_QUESTION,
  COLUMN_ORDERING_RESPONSE_CONTENT,
  OPEN_TEXT_QUESTION,
  OPEN_TEXT_RESPONSE_CONTENT,
